...
int main() {
	...
	unsigned int uniformLocation1 = glGetUniformLocation(shaderProgram, "ourTexture");
	unsigned int uniformLocation2 = glGetUniformLocation(shaderProgram, "ourTexture2");
